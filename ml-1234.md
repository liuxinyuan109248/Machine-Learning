...
<span style="color: #6FA8FF">**MNIST:**</span> A dataset of handwritten digits with 60,000 training and 10,000 test images. Each image is 28x28 pixels in grayscale, with a corresponding label from 0 to 9.

<span style="color: #6FA8FF">**ImageNet:**</span> Each image is 224x224 pixels in RGB, with a corresponding label from 0 to 999.
