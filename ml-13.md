...
2. **Acquisition Function:** Define an acquisition function $a(x)$ that quantifies the utility of evaluating the objective function at point $x$. Common choices include:
...
### <span style="color: #6ED3C5">Gradient Descent</span>
...
3. For $t = T$ down to $1$:
  ...
  $$d\theta = d\theta + \left(\dfrac{\partial g_t}{\partial \theta}\right)^T \dfrac{\partial L}{\partial g_t} = d\theta - (1 - \gamma_t) \nabla_\theta \nabla_w L(w_{t-1}, \theta, t) dv$$
...
### <span style="color: #6ED3C5">Random Search</span>
